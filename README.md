...
There are REST APIs for everything you can think of. Well, almost. This is a REST API documenting all the delicious (or not so much) chocolate milk drinks that I have tried over the last years. It's also my first Typescript project. Still learning...
